...
<body>
  ...
  <section id="registration" class="section">
    <div class="container tagline">
      ...
      <%--
        The path attribute do a data binding and map the property to the object on form modelAttribute.
        I.e. it will map the username to the field username to User object
       --%>
